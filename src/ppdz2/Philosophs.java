...
/*
    ...
    Ответ: Нет, нельзя. В таком случае нарушается одно из условий дедлока - циклическое ожидание.
    2. Можно ли организовать взаимную блокировку, если отдавать ресурсы в том-же порядке, в каком мы их берём?
    Ответ: По сути дедлока всё равно не будет, так как условие так же нарушается, потому что идет строгий порядок
    захвата, однако такйо подход может привести к логическим ошибкам.
 */